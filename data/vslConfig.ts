...
const commonCategories: VSLCategory[] = [
  {
    ...
    pricingSnippet: 'Typical meeting room projects start from $2,500.',
  ...
  },
  {
    ...
    pricingSnippet: 'Home studio and listening room packages usually start from $3,500.',
    ctaLabel: 'Get a free quote',
    ctaHref: '/contact',
    checkpoints: defaultCheckpoints,
  },
  {
    ...
    pricingSnippet: 'Church and hall treatments commonly range from $15,000 to $40,000+.',
    ctaLabel: 'Get a free quote',
    ctaHref: '/contact',
    checkpoints: defaultCheckpoints,
  },
